...
//  */
const handleTechSwiperResponsive = (sliderEl) => {
  ...
  if (isMobile) {
    ...
    if (swiperInstance === null) {
      ...
      swiperInstance = new Swiper(sliderEl, {
        ...
        pagination: {
          el: '.tech-swiper .main-pagination',
          type: 'bullets',
          clickable: true,
        },
    ...
    if (swiperInstance !== null) {
      ...
      const wrapperEl = sliderEl.querySelector('.tech-swiper__wrapper');
      if (wrapperEl) {
 ...
 */
export const initTechSwiper = () => {
  const sliderEl = document.querySelector('.tech-swiper');
  ...
  // Запуск при старте
  handleTechSwiperResponsive(sliderEl);
